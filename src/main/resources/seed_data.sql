-- =======================================================================
-- SEED DATA SCRIPT: TABLES DDL & SAMPLE ROWS
-- =======================================================================

-- 1. SELLER DOCUMENTS (3 Rows)
INSERT INTO seller_documents (seller_id, seller, document_type, document_number, document_url, file_name, file_type, file_size, status, rejection_reason, verified_by, verified_at, created_at, updated_at)
VALUES 
(101, 'UltraTech Direct', 'GST_CERTIFICATE', 'GSTIN27AAACU1234F1Z5', 'https://storage.hinchmart.com/documents/ultratech-gst.pdf', 'ultratech_gst_registration.pdf', 'application/pdf', 245820, 'APPROVED', NULL, 'Admin_Rajesh', NOW() - INTERVAL 10 DAY, NOW() - INTERVAL 12 DAY, NOW() - INTERVAL 10 DAY),
(102, 'Tata Steel Distributor', 'PAN_CARD', 'AAACT8821B', 'https://storage.hinchmart.com/documents/tatasteel-pan.pdf', 'tatasteel_corp_pan.pdf', 'application/pdf', 182040, 'APPROVED', NULL, 'Admin_Pooja', NOW() - INTERVAL 8 DAY, NOW() - INTERVAL 9 DAY, NOW() - INTERVAL 8 DAY),
(103, 'Astral Pipe Hub', 'TRADE_LICENSE', 'TL-MUM-2026-9812', 'https://storage.hinchmart.com/documents/astral-tradelicense.pdf', 'astral_trade_license_2026.pdf', 'application/pdf', 312500, 'PENDING', NULL, NULL, NULL, NOW() - INTERVAL 1 DAY, NULL);

-- 2. ACTIVITY LOGS (3 Rows)
INSERT INTO activity_logs (user_id, user_name, user_role, action, entity_type, entity_id, description, details, ip_address, user_agent, status, created_at)
VALUES 
(101, 'seller_ultratech', 'SELLER', 'LOGIN', 'AUTH', 101, 'Seller successfully authenticated from portal', '{"ip": "192.168.1.45", "device": "Chrome / Windows 11"}', '192.168.1.45', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/122.0', 'SUCCESS', NOW() - INTERVAL 4 HOUR),
(1, 'admin_rajesh', 'ADMIN', 'APPROVE_PRODUCT', 'PRODUCT', 3, 'Approved product listing: Tata Tiscon 550D TMT Rebar', '{"sku": "HN-STL-TATA-12MM", "approvalStatus": "APPROVED"}', '192.168.1.10', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', 'SUCCESS', NOW() - INTERVAL 2 HOUR),
(201, 'buyer_builder_infra', 'BUYER', 'ADD_TO_CART', 'CART', 1, 'Buyer added 5 Tons of Tata Tiscon 550D TMT Rebar with bulk pricing tier 2', '{"productId": 3, "quantity": 5, "tierUnitPrice": 60800.0, "subtotal": 304000.0}', '192.168.1.88', 'Mozilla/5.0 (iPhone; CPU iPhone OS 17_3 like Mac OS X)', 'SUCCESS', NOW() - INTERVAL 30 MINUTE);
...
-- 4. CART ITEMS (3 Rows)
-- Assuming cart_id = 1, and products 3 (Steel Rebar), 1 (OPC Cement), 5 (Astral CPVC Pipe)
INSERT INTO cart_items (cart_id, product_id, seller_id, seller, quantity, unit_price, gst_percentage, subtotal, created_at, updated_at)
VALUES 
(1, 3, 102, 'Tata Steel Distributor', 5, 60800.00, 18.0, 304000.00, NOW() - INTERVAL 40 MINUTE, NOW() - INTERVAL 40 MINUTE),
(1, 1, 101, 'UltraTech Direct', 100, 360.00, 28.0, 36000.00, NOW() - INTERVAL 30 MINUTE, NOW() - INTERVAL 30 MINUTE),
(1, 5, 103, 'Astral Pipe Hub', 25, 475.00, 18.0, 11875.00, NOW() - INTERVAL 20 MINUTE, NOW() - INTERVAL 20 MINUTE);

-- 5. PRODUCT BULK PRICES (Sample 3 Tiers for Steel)
INSERT INTO product_bulk_prices (product_id, min_quantity, max_quantity, price)
VALUES 
(3, 1, 4, 61500.00),
(3, 5, 9, 60800.00),
(3, 10, NULL, 59900.00);
...
-- =======================================================================
-- 6. ORDERS TABLE DDL & SEED DATA (3 Rows)
-- =======================================================================
...
-- =======================================================================
-- 7. ORDER ITEMS TABLE DDL & SEED DATA (3 Rows)
-- =======================================================================
...
-- =======================================================================
-- 8. ORDER STATUS HISTORY TABLE DDL & SEED DATA (3 Rows)
-- =======================================================================
...
-- =======================================================================
-- 9. DELIVERY PARTNERS TABLE DDL & SEED DATA (4 Logistics Carriers)
-- =======================================================================
...
-- =======================================================================
-- 10. SHIPMENTS TABLE DDL & SEED DATA (3 Rows)
-- =======================================================================
...
-- =======================================================================
-- 11. SHIPMENT TRACKING TABLE DDL & SEED DATA (6 Rows Checkpoints)
-- =======================================================================
...
-- =======================================================================
-- 12. NOTIFICATIONS TABLE DDL & SEED DATA (6 Rows)
-- =======================================================================
...
-- =======================================================================
-- 13. DEVICE TOKENS TABLE DDL & SEED DATA (3 Rows)
-- =======================================================================
...
-- =======================================================================
-- 14. NOTIFICATION PREFERENCES TABLE DDL & SEED DATA (3 Rows)
-- =======================================================================
